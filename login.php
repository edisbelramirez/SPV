        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="login-panel panel panel-default">
                <div class="panel-heading2">
                    ...
                    <center><h2 class="title">SPV</h2></center>
<center><p>Sistema de Planificaci&oacute;n de Videoconferencias</a></p></center>
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post">
                        <fieldset>
                            ...
                            <input type="submit" class="btn btn-lg btn-danger btn-block" value="Aceptar">
                        </fieldset>
                    </form>
                    <center><h6 class="title">Copyright © 2022</h6></center>
                    <center><p>Desarrollado por <a href="https://infotecstudio.nat.cu/">  Edisbel Ramirez Lovatos</a></p></center>
                </div>
            </div>
        </div>
