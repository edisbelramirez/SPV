        ...
        <?php
            while ($dados = $req->fetch(PDO::FETCH_ASSOC)) {
                ...
                <form class=\"form-horizontal\" method=\"POST\" action=\"menu/aceita.php\">
                        ...
                        $nome_usuario, te est&aacute; convidando a participar en la videoconferencia de $nome_evento el d&iacute;a $data_inicio, de clic en el bot&oacute;n aceptar para confirmar el evento.
                        <br>
